...
<html lang="zh-cn">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Loli Cloud -生活在异次元的虚拟主机商家</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Loli Cloud -生活在异次元的虚拟主机商家" />
        <meta name="keywords" content="Loli Cloud, VPS, 圆云云计算, 虚拟主机, 我的世界面板服" />
        <meta content="Shreethemes" name="author" />
        <!-- favicon -->
        <link href="https://assest.cdn.littlesheep.cc/images/wawcloud_icon.svg" rel="shortcut icon" >
        <!-- Bootstrap -->
        <link href="https://assest.cdn.littlesheep.cc/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- Magnific Popup -->
        <link href="https://assest.cdn.littlesheep.cc/css/magnific-popup.css" rel="stylesheet" type="text/css" />
        <!-- Slider -->               
        <link href="https://assest.cdn.littlesheep.cc/css/owl.carousel.min.css" rel="stylesheet" /> 
        <link href="https://assest.cdn.littlesheep.cc/css/owl.theme.default.min.css" rel="stylesheet" /> 
        <!-- Icons -->
        <link href="https://assest.cdn.littlesheep.cc/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Css -->
        <link href="https://assest.cdn.littlesheep.cc/css/style.css" rel="stylesheet" type="text/css" id="theme-opt" />
        <link href="https://assest.cdn.littlesheep.cc/css/colors/default.css" rel="stylesheet" id="color-opt">
        <link href="https://cdn.bootcdn.net/ajax/libs/mdui/1.0.1/css/mdui.min.css" rel="stylesheet" crossorigin="anonymous"/>
        <link href="https://assest.cdn.littlesheep.cc/misans@3.1.1/lib/misans-400-regular.min.css" rel="stylesheet"  />
        <style>
        @font-face {
            font-family: MiSans;
            font-display: swap;
    ...
    <body>
        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <div>
                    <a class="logo" href="/">
                        <img src="https://cdn.img.lgdl.lol/uploads/2022/08/03/62ea13b4039df.png" class="l-dark" height="16" alt="">
                        <img src="https://cdn.img.lgdl.lol/uploads/2022/08/03/62ea13b403ad3.png" class="l-light" height="16" alt="">
                    </a>
                </div>     

                <div class="buy-button">
                    <a href="https://cloud.loli.bike/login" class="text-dark h6 mr-3 login" >登陆</a>
                    <a href="https://cloud.loli.bike/register" target="_blank" class="btn btn-primary">立刻注册</a>
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-light">
                        ...
                        <ul class="navigation-menu nav-light">
                        <li class="buy-button">
                            <a href="https://cloud.loli.bike/cart?fid=17" class="text-dark h6 mr-3 login" >WVM服务器</a>
                        </ul>
                        </li>
                        
                        <ul class="navigation-menu nav-light">
                        <li class="buy-button">
                            <a href="https://cloud.loli.bike/cart?fid=6" class="text-dark h6 mr-3 login" >WVH虚拟主机</a>
                        </ul>
                        </li>
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3">Loli Cloud -生活在异次元的虚拟主机商家</h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">WaW Cloud，一年的用心耕耘，香港，美国，中国直属机房提供高速线路，只为提高更好的服务</p>
                        
                            <div class="mt-4">
                                <a href="https://cloud.loli.bike/register" class="btn btn-primary mx-1">立刻注册</a>
                                <a href="https://cloud.loli.bike/login" class="btn btn-light mx-1">立即登陆</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/shared.svg" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/vps.svg" alt="">
                            </div>
                            <div class="card-body p-0 content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/dedicated.svg" alt="">
                            </div>
                            <div class="card-body p-0 content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/cloud.svg" alt="">
                            </div>
                            <div class="card-body p-0 content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/reseller.svg" alt="">
                            </div>
                            <div class="card-body p-0 content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card services p-4 rounded-pill border-0">
                            <div class="icon text-center mb-4">
                                <img src="https://assest.cdn.littlesheep.cc/images/icons/domain.svg" alt="">
                            </div>
                            <div class="card-body p-0 content">
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="mr-lg-5">
                            <img src="https://assest.cdn.littlesheep.cc/images/features/1.png" class="img-fluid" alt="">
                        </div>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
                        <div class="ml-lg-5">
                            <img src="https://assest.cdn.littlesheep.cc/images/features/2.png" class="img-fluid" alt="">
                        </div>
                    </div><!--end col-->
                ...
                <div class="row">                    
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate border-0 rounded overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="https://cloud.loli.bike/cart" class="btn btn-primary mt-4">立即选购</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate best-plan border-0 rounded overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="https://cloud.loli.bike/cart?fid=17&gid=62&pid=108" class="btn btn-primary mt-4">现在试试</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card pricing hosting-rate border-0 rounded overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a href="https://cloud.loli.bike/cart?fid=13&gid=52&pid=101" class="btn btn-primary mt-4">现在开始</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-12 mt-4 pt-2 text-center">
                        <div class="alert alert-light alert-pills mb-0" role="alert">
                            ...
                            <span class="content"> <a href="https://cloud.loli.bike/cart" class="text-primary">查看计划详情</a> 和定价更多细节</span>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                                    ...
                                    <ul class="list-unstyled footer-list mt-4">
                                        <li><a href="https://cloud.loli.bike/cart?fid=6" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>WVH 虚拟主机</a></li>
                                        <li><a href="https://cloud.loli.bike/cart?fid=17" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>WVM 服务器</a></li>
                                        <li><a href="https://cloud.loli.bike/cart?fid=13" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>WMC MC主机</a></li>
                                        <li><a href="https://cloud.loli.bike/cart?fid=15" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>WDN CDN加速</a></li>
                                    </ul>
                                </div>
                ...
                <div class="row text-center">
                    <div class="col-sm-6 col-md-7">
                        <div class="text-sm-left">
                            <p class="mb-0 text-foot">© 2021-2023 WaW Cloud. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="https://www.tcbwork.com/" target="_blank" class="text-reset">TCB Work's Cloud 运营部</a>.</p>
                        </div>
                    </div><!--end col-->
        ...
        <!-- javascript -->
        <script src="https://assest.cdn.littlesheep.cc/js/jquery.min.js"></script>
        <script src="https://assest.cdn.littlesheep.cc/js/bootstrap.bundle.min.js"></script>
        <script src="https://assest.cdn.littlesheep.cc/js/jquery.easing.min.js"></script>
        <script src="https://assest.cdn.littlesheep.cc/js/scrollspy.min.js"></script>
        <!-- Magnific Popup -->
        <script src="https://assest.cdn.littlesheep.cc/js/jquery.magnific-popup.min.js"></script>
        <script src="https://assest.cdn.littlesheep.cc/js/magnific.init.js"></script>
        <!-- SLIDER -->
        <script src="https://assest.cdn.littlesheep.cc/js/owl.carousel.min.js"></script>
        <script src="https://assest.cdn.littlesheep.cc/js/owl.init.js"></script>
        <!-- Icons -->
        <script src="https://assest.cdn.littlesheep.cc/js/feather.min.js"></script>
        <!-- Main Js -->
        <script src="https://assest.cdn.littlesheep.cc/js/app.js"></script>
